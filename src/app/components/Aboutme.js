...
export default function AboutSection() {
  ...
  return (
    <div className="bg-zinc-950 text-zinc-100 py-6">
      <h2 className="text-4xl text-center mb-2 text-white">About Me</h2>
      <div id="about" ref={sectionRef}>
        <div className="p-4">
          <div>
            <p className="w-full text-center text-zinc-300 animate-pulse">
              Hi! I&apos;m Ibrahim Ahmed, a passionate Front-End Developer based
              in Cairo, Egypt. I specialize in building responsive, clean, and
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-6 text-center">
                {skills.map((skill) => (
                  ...
                  >
                    <p className="text-sky-400 font-medium text-center w-full py-4 h-14">
                      {skill.name}
                    </p>
                  </div>
                ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3  py-4 gap-3 text-center mt-6">
            {[
              {
                icon: "🎨",
