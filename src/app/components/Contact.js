...
import { guestsComments } from "../lib/actions/contact";
...
export default function Contact() {
  ...
  async function handleSubmit(e) {
    ...
    const result = await guestsComments(formData);
  ...
  return (
    <div
      className="bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 text-white p-8 overflow-hidden min-h-screen"
      id="contact"
    >
      ...
      <div ref={sectionRef} className="max-w-2xl mx-auto">
        ...
        >
          ...
          <button
            type="submit"
            disabled={isSubmitting}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-all hover:shadow-lg hover:shadow-blue-500/50 hover:-translate-y-1 cursor-pointer"
          >
